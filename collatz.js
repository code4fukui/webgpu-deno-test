...
const uintData = await calcIntToInt(shaderCode, numbers);
const OVERFLOW = 0xffffffffff;
const checkedData = Array.from(uintData).map((n) => n == OVERFLOW ? "OVERFLOW": n.toString());
